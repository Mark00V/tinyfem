...
- Please refer to [EXAMPLES](examples/examples tinyfem.pdf) for capabilities demonstration.
### Limitations
...
However, the technical correctness has been verified by comparing it with other FEM frameworks, and reasonable agreement was found for the analyzed examples (see: [VERIFICATION](supp/verification tinyfem.pdf)). In case of doubt, the results must be independently verified.

## Running TinyFEM
### Workflow
- Please refer to the [QUICK DOCUMENTATION](supp/quick documentation tinyfem.pdf) for the workflow.
